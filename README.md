...
openapi-generator generate -i ./openapi.yaml -g rust-axum -p packageName=generated -o ./server/generated
```

```shell
# dev
curl -X POST -H 'Content-Type: application/json' -d '{"bookmarkDirectoryList":[{"title":"test1","bookmarkList":[{"title":"a","url":"b"},{"title":"c","url":"d"}]}]}' http://127.0.0.1:50051/bookmarks
